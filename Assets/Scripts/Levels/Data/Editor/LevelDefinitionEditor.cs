...
{
    /// <summary>
    /// Custom inspector for <see cref="LevelDefinition"/> that provides a paintable grid
    /// and validation helpers for authoring levels.
    /// </summary>
    ...
    public class LevelDefinitionEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty m_LevelRulesProp, m_SkinLibrary;
        ...
        private void OnEnable()
        {
            ...
            m_SkinLibrary = serializedObject.FindProperty("SkinLibrary");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_SkinLibrary);
        ...
        private void ValidateAndLog()
        {
            ...
            for (var i = 0; i < m_CellsProp.arraySize; i++)
            {
                ...
                {
                    ZzzLog.LogWarning($"Cell position out of range: {cellPos.x}, {cellPos.y} at index {i}");
                }
                if (!seen.Add(cellPos))
                {
                    ZzzLog.LogWarning($"Duplicate cell position: {cellPos.x}, {cellPos.y} at index {i}");
                }
            }
        }
    }
